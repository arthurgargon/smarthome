...
//òîëüêî äëÿ ïðåäîòâðàùåíèÿ ìíîãîêðàòíîãî âûçîâà ïðè óäåðæèâàíèè êíîïêè íàæàòîé
char buttonStates = 0;

ISR(TIMER1_COMPA_vect){
	sei();	//ðàçðåøàåì ïðåðûâàíèÿ áîëåå âûñîêîãî ïðèîðèòåòà (clunet)
	...
	if (a > 0){
		...
		cmd(0, CLUNET_BROADCAST_ADDRESS, COMMAND_VOLUME_UP, 1);	// íå îòïðàâëÿåì response ñðàçó
	}else if (a < 0){
		shouldSendDelayedResponse = 1;
		delayedResponseCounterValue = TCNT1;
		cmd(0, CLUNET_BROADCAST_ADDRESS, COMMAND_VOLUME_DOWN, 1);  // íå îòïðàâëÿåì response ñðàçó
	}
	...
	//îòïðàâëÿåì íå ðàíüøå ÷åì ÷åðåç 150 ìñ, íî âñå ðàâíî ðâåòñÿ ïðåðûâàíèåì è îòïðàâëÿåòñÿ òîëüêî ïî îêîí÷àíèè ëþáîé äëèòåëüíîé îïåðàöèè
...
/*
*	Âûïîëíÿåò êîìàíäó è, ïðè íåîáõîäèìîñòè, îòïðàâëÿåò 
*	èíôîðìàöèîííîå ñîîáùåíèå â ñåòü CLUNET
*/
