...
/*Команда управления FM-приемником
	...
	0x02, (2 байта, ex. 99.9МГц = 9990) - настроить частоту
	0x03, (1 байт номер канала) - переключить на сохраненный канал
	0x04 - переключить на следующий сохраненный канал
	0x05 - переключить на предыдущий сохраненный канал
	
	0x07 - поиск
	
	0x10, (1 байт: команда; 1 байт: 0/1 - off / on) - выполнить управляющую команду
			00 - standby;
			01 - mono;
			02 - mute;
			03 - hcc;
	...
	0xEE, (2 байта: 0xEE; 0xEF) - стереть все сохраненные программы
*/
