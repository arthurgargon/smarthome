...
#define COMMAND_ROTARY_DIAL_NUMBER_INFO 0x24
/* Сообщает код набранный с помощью диска телефона
	1-ый байт:
		0x00 - начат набор номера
		0x01 - номер набран
		0x02 - набираемый номер
		0x03 - набор номера прерван
	2-ой байт-до конца сообщения:
		для режимов 0x01, 0x02: номер
*/
