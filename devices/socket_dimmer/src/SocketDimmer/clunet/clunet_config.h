...
#define CLUNET_DEVICE_ID 0x20
/*32 dec*/

/* Device name */
#define CLUNET_DEVICE_NAME "Socket dimmer"
...
/*
	Позволяет управлять режимом низкоприоритеной работы сети clunet.
	Разрешая прочие прерывания во время обработки прерываний сети clunet.
	Полезно для высокоприоритеных задач, однако снижает надежность
	передачи/приема сообщений
*/
#define CLUNET_USE_LOW_PRIORITY_MODE
...
//к сохранению команд
#define CLUNET_BUFFERED_DATA_MAX_LENGTH 24

/* Размер буфера входящих сообщений 
	Устанавливать исходя из свободной ОЗУ (2-20 шт) 
*/
#define CLUNET_BUFFERED_BUFFER_SIZE 10
